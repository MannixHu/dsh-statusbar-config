	...
	factory: (require) => {
		...
		*/
		...
		function ConfigurableStatsLine({ settings, t, useChat, useSession, useProjection }) {
			...
			const stats = (0, react.useMemo)(() => projectedStats ?? deriveStats(legacyNodes ?? []), [projectedStats, legacyNodes]);
			...
			const hasData = (stats?.steps ?? 0) > 0 || usage !== void 0 && (usage.uncachedInputTokens + usage.cacheReadTokens + usage.cacheWriteTokens > 0 || usage.outputTokens > 0);
